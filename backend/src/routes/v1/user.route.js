...
const { auth, emailVerified } = require('../../middlewares/auth');
...
router
  ...
  .patch(auth(), emailVerified, validate(userValidation.updateUser), userController.updateMe)
 ...
 *     description: Update logged in user's information.
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
